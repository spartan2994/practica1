...
<center>
  ...
  <DIV  STYLE="position: absolute; top: 40px; left: 369px; width: 69px; height: 33px;visibility:visible z-index:1"> <a href="tf.html"><img src="blog.png"
    ...
    <DIV  STYLE="position: absolute; top: 59px; left: 1077px; width: 69px; height: 33px;visibility:visible z-index:1"> <a href="tf2.html"><img src="logout.png"
                id="imglog"
                onmouseover="imglog.src='logout1.png'"
                onmouseout="imglog.src='logout.png';"/></a>
    </div>
...
?>
         <span class="aw"><br />
         <p>BIENVENIDO          
         <p>YA PUEDES COMPRAR!<br />
           </label>
        <DIV STYLE="position: absolute; top: 28px; left: 26px; width: 160px; height: 54px; visibility:visible z-index:1; font-size: larger; font-family: 'AR BERKLEY';"> <a href="fut_in.php"><img src="logobon.png" alt="logo" width="162" height="59" /></a>
          </div>
        </p>
         <p>&nbsp; </p>
      <p>&nbsp;</p>
	...
	<tr>
      ...
      <td><p>&nbsp;</p>
        ...
        <table width="208" border="1">
          ...
          <tr>
            <td height="123" colspan="2" bgcolor="#D6D6D6"><span class="zsdf"><center><img src="../Ramon/comprar.jpg" width="151" height="71" /></center></span></td>
          </tr>
        </table>
        <p><span class="xc">
          <?php }?>
