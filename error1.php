...
<header>
     ...
     <ul class="menu">
       ...
       <li><a href="#">NUEVOS ARTICULOS</a></li>
         ...
         <li><a href="#">GALERIA</a></li><br>
        <li><a href="index.php">|  CERRAR SESION  |</a></li><br>
     </nav>
    </ul>
...
?>
    ...
    <table width="161" border="0">
         <tr bgcolor="#grey">
           <td width="155" bgcolor="grey" class="sasa"><table width="200" border="0">
             <tr>
               <td><p class="zsdf"><?php echo $Nombre ?></p></td>
             </tr>
             <tr>
               <td><span class="zsdf"><?php echo $Descripcion ?></span></td>
             </tr>
             <tr>
               <td><span class="zsdf"><?php echo $Precio ?></span></td>
             </tr>
             <tr>
               <td><span class="zsdf"><?php echo $Existencia ?></span>
                 <table width="200" border="0">
                   <tr>
                     <td><span class="zsdf"><a href="error1.php"><?php echo $Imagen ?></a></span></td>
                   </tr>
                 </table>
               <span class="zsdf"><a href="error1.php"><a href="error1.php"><img src="comprar.png" alt="aa" name="img12" width="63" height="27" border="0"/></a></a></span></td>
             </tr>
           </table></td>
         </tr>
  </table>
...
$error1= ' <script type="text/javascript" >

alert("Tu compra se ha agregado a tu carrito de compras");
