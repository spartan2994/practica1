...
<div id="caja">
  ...
  <form action="" method="POST">
    ...
    <input type="text" name="PRODUCTO" placeholder="Id del producto" />
  <input type="text" name="ADMIN" placeholder="Id del administrador" />
  <input type="text" name="FECHA" placeholder="Fecha" />
    <input type="text" name="CANTIDAD" placeholder="Cantidad" />
    <input type="submit" name="Registra" value="Registrar"/>
    <a href="http://bogoduba.webcindario.com/producto.php">Atras</a>
...
if (isset($_GET['id_venta'])){
    echo '<p>Producto:'.$_GET['id_venta'].'</p>';
}
