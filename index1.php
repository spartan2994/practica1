...
#derechos {color: rgb(76,76,76); /* Old browsers */
...
<header>
     ...
     <ul class="menu">
          ...
          <li><a href="index.php">  CriYan  </a></li>
              
         
       <li><a href="articulos.php">ARTICULOS</a></li>
         <li><a href="contactanos.php">CONTACTANOS</a></li>
        <li><a href="login_new.php">|  INICIAR SESION  |</a></li><br>
         <li><a href="registro.php">|  CREAR CUENTA  |</a></li></nav>
    </ul>
  ...
  <div class="search_bar">
       ...
       <input name= "BUSCAR" type="text" id="bar" placeholder="Buscar...">
...
?>
	    ...
	    $consulta=@mysql_query("select * from  productos where Nombre like '%".$_POST['BUSCAR']."%' order by Nombre");}
    ...
    <table width="444" border="0">
         <tr bgcolor="grey">
           <td width="274" height="4" bgcolor="grey" class="dv"><p><img src="<?php echo $Imagen; ?>"width="83" height="98" /><span class="zsdf">|<?php echo $Nombre ?></span>|</p>
           <p><a href="error.php"><img src="comprar.png" alt="aa" name="img12" width="63" height="27" border="0"/></a></p></td>
           <td width="10" bgcolor="grey">&nbsp;</td>
           <td width="155" bgcolor="grey">&nbsp;</td>
         </tr>
         <tr bgcolor="grey">
           <td height="5" bgcolor="grey" class="dv"><span class="zsdf"><?php echo $Nombre ?></span></td>
           <td bgcolor="grey">&nbsp;</td>
           <td bgcolor="grey">&nbsp;</td>
         </tr>
         <tr bgcolor="grey">
           <td height="36" bgcolor="grey" class="dv"><span class="zsdf"><?php echo $Descripcion ?></span></td>
           <td height="36" bgcolor="grey">&nbsp;</td>
           <td bgcolor="grey" class="dv">&nbsp;</td>
         </tr>
         <tr bgcolor="#grey">
           <td bgcolor="grey" class="dv">$<span class="zsdf"><?php echo $Precio ?></span></td>
           <td bgcolor="grey">&nbsp;</td>
           <td bgcolor="grey" class="dv">&nbsp;</td>
         </tr>
         <tr bgcolor="#grey">
           <td bgcolor="grey" class="dv"><span class="zsdf"><?php echo $Existencia ?> en existencia</span></td>
           <td bgcolor="grey">&nbsp;</td>
           <td bgcolor="grey" class="dv">&nbsp;</td>
         </tr>
  </table>
