...
?>
	    ...
	    $Nombre=$filas['nombre'];
        $Descripcion=$filas['descripcion_prod'];
		
		$Precio=$filas['precio'];
		$Existencia=$filas['existencia'];
		$Imagen=$filas['imagen_prod'];
    ...
    <table width="161" border="0">
         <tr bgcolor="#grey">
           <td width="155" bgcolor="grey" class="sasa"><table width="200" border="0">
             ...
             <tr>
               <td><span class="zsdf">Existencias: <?php echo $Existencia ?></span>
                 <table width="200" border="0">
                   <tr>
                     <td><span class="zsdf"><?php echo $Imagen ?><a href="error1.php"></a></span></td>
                   </tr>
                 </table>
               <span class="zsdf"><a href="error1.php"><a href="error1.php"></a></a></span></td>
             </tr>
           </table></td>
         </tr>
  </table>
