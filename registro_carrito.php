...
<div id="caja">
  ...
  <form action="" method="POST">
    ...
    <input type="text" name="Apellidos" placeholder="Ingresa tu direccion" />
  <input type="text" name="Direccion" placeholder="Ingresa tu numero de tarjeta" />
  <input type="text" name="Telefono" placeholder="Ingresa tu numero de seguridad" />
  <input type="text" name="User" placeholder="Ingresa tu numero de vigencia" />
  <input type="text" name="Password" placeholder="Ingresa tu tipo de tarjeta" />
  <input type="text" name="rpass" placeholder="Ingresa el nombre del producto" />
   <input type="submit" name="Registra" value="Registrar compra"/>
   
   <a href="login_new.php">Ir a login</a>  
</form>
  <?php
...
<DIV  STYLE="position: absolute; top: 73px; left: 125px; width: 254px; height: 33px;visibility:visible z-index:1">
<DIV id="fuera" STYLE="position: absolute; top: 1px; left: 415px; width: 254px; height: 33px;visibility:visible z-index:1">
  C </div>
<DIV id="fuera1" STYLE="position: absolute; top: 21px; left: 470px; width: 254px; height: 33px;visibility:visible z-index:1">
  r </div>
<DIV id="fuera2" STYLE="position: absolute; top: 22px; left: 492px; width: 254px; height: 33px;visibility:visible z-index:1">
  i </div>
<DIV id="fuera3" STYLE="position: absolute; top: 29px; left: 525px; width: 254px; height: 33px;visibility:visible z-index:1">
Y  </div>
<DIV id="fuera4" STYLE="position: absolute; top: 61px; left: 575px; width: 254px; height: 33px;visibility:visible z-index:1">
  a </div>
  <DIV id="fuera6" STYLE="position: absolute; top: 62px; left: 601px; width: 254px; height: 33px;visibility:visible z-index:1">
  n</div>
</div>
</body>
</html>
