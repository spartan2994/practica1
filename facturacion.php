...
<header>
     ...
     <ul class="menu">
          ...
          <li><a href="buscador.php">  BoGoDuBa  </a></li>
       
              
         
       <li><a href="http://bogoduba.webcindario.com/clientes.php">CLIENTES</a></li>
         <li><a href="http://bogoduba.webcindario.com">PRODUCTOS</a></li>
         <li><a href="http://bogoduba.webcindario.com/venta_1.php">VENTAS</a></li><br>
  ...
  <ul class="menu1">
	    ...
	    $consulta=@mysql_query("select * from clientes where id_cliente like '%".$_POST['BUSCAR']."%'");}
...
<table width="413 auto" border="0">
  <tr>
    <td width="135 auto" class="adad">MATERIAS CURZADAS</td>
    <td width="135 auto" class="fF">'.$DIRECCION.'</td>
...
$dompdf->render();
$dompdf->stream("Factura de ".$Nombre.".pdf");		
		?>
